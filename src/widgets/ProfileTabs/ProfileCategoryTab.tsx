...
const MIN_BAR_HEIGHT_PER_SKILL = 30; // Минимальная высота для одного навыка в графике
      ...
      <div className="bg-white p-6 rounded-lg shadow relative">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center">
            ...
            <StarRating rating={profileSkillCategory.rating * 0.05} />
          </div>
        </div>
...
ProfileCategoryTab.displayName = "ProfileCategoryTab"; // Переименовано
